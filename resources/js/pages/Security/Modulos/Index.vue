...
const deleteModulo = () => {
    if (!selectedModulo.value) {
        showToast('No se seleccionó ningún módulo', 'error');
        return;
    }
    axios.delete(`/modulos/${selectedModulo.value.id}`)
        .then(() => {
            reloadData()
...
const editModulo = () => {
    ...
    formRef.value.openDialog(selectedModulo.value);
}
            ...
            <div class="p-4">
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="overflow-x-auto">
                        <DataTable ref="dataTableRef" fetchUrl="modulos/list" :columns="[
